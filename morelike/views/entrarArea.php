		...
		<div class="col-6">
			...
			<div id="listadoFicheros">
                <form class="formFicheros" action="<?=base_url()?>Upload_Controller/do_upload" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="idarea" id="idarea" value="<?php =$id;?>">
                    <input type="hidden" name="rolarea" id="rolarea" value="<?php =$rol;?>">
                    <input type="hidden" name="nombrearea" value="<?php =$area;?>">
