...
<head>
  ...
  <link href="<?php =base_url()?>css/agency.css" rel="stylesheet">

  <!--script src="<?php =base_url()?>js/jquery.form.min.js"></script-->
    ...
    <div id="asd" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item active">
            <img class="img-fluid" src='<?php =base_url()?>img/enf1.png'>
          ...
          <div class="carousel-item">
            <img class=" img-fluid" src='<?php =base_url()?>img/enf2.png'>
            <div class="carousel-caption" style="background-color:#0675ad;opacity: 90%;padding: 0;">
              <p class="lead" style="color:white; font-weight: bolder;">Coronavirus: La Prevención es tarea de todos.</p>
            </div>
          </div>
          <div class="carousel-item">
            <img class=" img-fluid" src='<?php =base_url()?>img/enf3.png'>
            <div class="carousel-caption" style="background-color:#0675ad;opacity: 90%;padding: 0;">
              <p class="lead" style="color:white; font-weight: bolder;">#ElMejorEquipoMedico</p>
            </div>
          </div>
          <div class="carousel-item">
            <img class=" img-fluid" src='<?php =base_url()?>img/enf4.png'>
            <div class="carousel-caption" style="background-color:#0675ad;opacity: 90%;padding: 0;">
